    ...
    "type": "function",
      "function": {
        ...
        "parameters": {
          ...
          "required": ["product"],
          "properties": {
            "product": {"type": "string", "description": "The name of the product(keyboard, Iphone, mouse, laptop)"}
          }
        }
    }
    },
    ...
    "type": "function",
      "function": {
        ...
        "parameters": {
          ...
          "properties": {
            "discount_tier": {"type": "string", "description": "Available tiers: bronze, silver, gold"},
